...
#pragma omp parallel for
    ...
    inline void MRQGBuilder::add_pruned_edges(
    ...
    inline void MRQGBuilder::heuristic_prune(
    ...
    inline void MRQGBuilder::search_new_neighbors(bool refine) {
#pragma omp parallel for schedule(dynamic)
    ...
    inline void MRQGBuilder::random_init() {
        const PID min_id = 0;
...
#pragma omp parallel for schedule(dynamic)
    ...
    inline void MRQGBuilder::graph_refine() {
...
#pragma omp parallel for schedule(dynamic)
    ...
    inline void MRQGBuilder::iter(bool refine) {
        if (refine) {
            for (size_t i = 0; i < num_nodes_; ++i) {
